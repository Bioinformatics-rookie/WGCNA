本代码借鉴了[生信技能树的WGCNA教程](https://github.com/jmzeng1314/my_WGCNA)以及[PlanTech的WGCNA课程](https://ke.qq.com/course/430201)编写，转载请注明出处, 源代码与数据我已上传至github
...
1. 表达矩阵（All_fpkm.list）
   ...
   ![](Categorical/img/image-20200802142219001.png)

2. 表型文件,需要注意表型文件分为两类，连续变量型与分类变量型，本教程两种表型变量都会运行

![](Categorical/img/image-20200802142335624.png)

<center>
    连续变量
</center>

![image-20200803165842485](Categorical/img/image-20200803165842485.png)
...
![](Categorical/img/step1-sample-cluster.png)
...
![](Categorical/img/step2-beta-value.png)
...
![](Categorical/img/step4-genes-modules.png)

![](Categorical/img/sample-subtype-cluster.png)
...
![](Categorical/img/step5-Module-trait-relationships.png)

两两模块之间的邻接矩阵，主要看不同模块之间的相关性

![](Categorical/img/wgcna.adjacency.heatmap.png)
...
![](Categorical/img/wgcna.pink.express.barplot.png)
...
![](Categorical/step6-Module_membership-gene_significance.png)
...
![](Categorical/img/step6-Eigengene-dendrogram.png)
...
![](Categorical/img/step7-Network-heatmap.png)
